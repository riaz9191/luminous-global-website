  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={index}
                className={`text-center space-y-4 ${whyInView ? `opacity-100 animate-fadeUp delay-${(index + 1) * 100}` : "opacity-0"}`}
              >
                <div className={`w-20 h-20 bg-${item.color}-100 rounded-full flex items-center justify-center mx-auto`}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <Card
                key={index}
                className={`bg-white/10 border-white/20 text-white backdrop-blur-sm hover-lift ${marketsInView ? `opacity-100 animate-fadeUp delay-${(index + 1) * 100}` : "opacity-0"}`}
              >
                <CardHeader className="text-center">
      ...
      <section id="products" ref={productsRef} className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-16 ${productsInView ? "opacity-100 animate-fadeUp" : "opacity-0"}`}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={index}
                className={`border-0 shadow-lg hover-lift overflow-hidden ${productsInView ? `opacity-100 animate-fadeUp delay-${(index + 1) * 100}` : "opacity-0"}`}
              >
      ...
      {/* Contact Section - Fixed Mobile Layout */}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className={`${contactInView ? "opacity-100 animate-fadeUp delay-100" : "opacity-0"}`}>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={index}
                      className={`flex items-center space-x-4 ${contactInView ? `opacity-100 animate-fadeUp delay-${(index + 2) * 100}` : "opacity-0"}`}
                    >
            ...
            <div className="w-full">
              <Card
                className={`border-0 shadow-lg hover-lift w-full ${contactInView ? "opacity-100 animate-fadeUp delay-200" : "opacity-0"}`}
              >
                <CardHeader>
